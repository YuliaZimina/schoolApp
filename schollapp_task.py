...
#TODO
"""Ваша задача:
1. Добавьте класс, который будет определять Самостоятельную работу 
2. Создайте предмет "Русский язык" с описанием и приоритетом, которые вы считаете подходящими.
Добавьте к предмету "Русский язык" несколько заданий различных типов:
Домашнее задание без оценки
Домашнее задание с оценкой 
Домащнее задание с оценкой 
Контрольная работа с оценкой
Самостоятельная работа без оценки
Самостоятельная работа с оценкой
И любое другое количество заданий на ваше усмотрение. 
Заполните каждое задание содержанием, ответами и, если необходимо, оценкой и комментариями.
3. Выведите в консоль всю информацию о предмете "Русский язык" и заданиях для него
4. Выведите в консоль только те задания, у которых оценка не выставлена или ниже 4. 
